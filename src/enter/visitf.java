 ...
 * @author ABDULRHMAN
 */
public class visitf extends javax.swing.JFrame {

    /**
     * Creates new form visitf
     */
    public visitf() {
        initComponents();
         try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(visitf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
